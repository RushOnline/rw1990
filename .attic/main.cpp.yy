...
const int switchPin = 3; // Будем использовать аппаратное прерывание INT0, поэтому кнопка должна быть подключена к 3-му пину
const int dataPin = 2; // Data пин считывателя ключей
